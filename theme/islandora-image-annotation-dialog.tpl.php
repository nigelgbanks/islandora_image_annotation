 ...
 */
?>
<div id="islandora-image-annotation-create-annotation-dialog" style="display: none;">
  <?php print $annotation_icons; ?>
  <hr/>
  <label for="islandora-image-annotation-create-annotation-title">Title:</label>
  <input id="islandora-image-annotation-create-annotation-title" type="text" size="28" />
  <label for="islandora-image-annotation-create-annotation-type">Type:</label>
  <input id="islandora-image-annotation-create-annotation-type" type="text" size="28" />
  <?php if ($use_entity_tagging): ?>
    <label for="islandora-image-annotation-create-annotation-entity-type">Entity</label>
    <select id="islandora-image-annotation-create-annotation-entity-type" class="easyui-combobox" name="Add Entity" style="width:100px;">
    ...
    <input id="islandora-image-annotation-create-annotation-entity" />
  <?php endif; ?>
  <?php if ($can_choose_colour): ?>
    <label for="islandora-image-annotation-create-annotation-color">Color:</label>
    <input id ="islandora-image-annotation-create-annotation-color" name="color4" value="#91843c" class="color-picker" size="7" />
  <?php endif; ?>
  <label for="islandora-image-annotation-create-annotation-stroke-width">Stroke Width:</label>
  <input id="islandora-image-annotation-create-annotation-stroke-width" type="text" size="5" value=".3" />
  <label for="islandora-image-annotation-create-annotation-text">Annotation:</label>
  <textarea id="islandora-image-annotation-create-annotation-text" cols="40" rows="5"></textarea>
</div>
